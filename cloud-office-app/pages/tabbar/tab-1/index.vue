  ...
  <view class="tabBox">
    <view class="headerBox">
      <view class="unit-info">
        <image class="unit-icon" v-if="enterprice.enterprice_image" :src="getComLogo(enterprice.enterprice_image)" mode=""></image>
      ...
      <u-grid :col="4" :border="false">
        <u-grid-item @click="jumpTo('generationOffice')">
          <view style="position:relative">
            ...
            <image class="grid-icon" style="width: 50rpx;height: 54rpx;position: relative;" src="../../../static/image/tab1/menu1.png" mode="">
            </image>
          </view>
        ...
        <u-grid-item @click="jumpTo('leaveMessage')">
          <view style="position:relative">
            ...
            <image class="grid-icon" style="width: 50rpx;height: 54rpx;" src="../../../static/image/tab1/menu2.png" mode="">
            </image>
          </view>
          <view class="grid-text">留言</view>
        </u-grid-item>
        <u-grid-item @click="goSchedule">
          <image class="grid-icon" style="width: 50rpx;height: 54rpx;" src="../../../static/image/tab1/menu3.png" mode="">
          </image>
    ...
    <view class="chargeBox">
      <view class="chargeMain">
        ...
        <view class="carge-item" v-for="(item,index) in daiBanListData.slice(0,3)" :key="index" @click="goDaiBanDetail(item)">
    ...
    <!-- 财务核算 -->
    <financialAccounting v-if="!isLogin || personType==1 || personType==3" @changeFinancialPopup="changeFinancialPopup" :accountText="accountText"></financialAccounting>
    <!-- 三方服务 -->
      ...
      <view class="statementMain">
        ...
        <u-grid :col="4" :border="false" style="margin-top: 12rpx;">
          <u-grid-item @click="jumpTo('incomeStatement')">
            <image class="grid-icon" style="width: 50rpx;height: 54rpx;" src="../../../static/image/tab1/c1.png" mode="">
            </image>
            <view class="grid-text">利润表</view>
          </u-grid-item>
          <u-grid-item @click="jumpTo('cashFlowStatement')">
            <image class="grid-icon" style="width: 50rpx;height: 54rpx;" src="../../../static/image/tab1/c2.png" mode="">
            </image>
            <view class="grid-text">现金流量表</view>
          </u-grid-item>
          <u-grid-item @click="jumpTo('assetAndLiability')">
            <image class="grid-icon" style="width: 50rpx;height: 54rpx;" src="../../../static/image/tab1/c3.png" mode="">
            </image>

	...
	<view>
		...
		<view class="view-list">
			...
			<view class="flex flex-ac">
				...
				<u-switch space="2" v-model="direction" size="30" inactiveColor="rgb(245, 108, 108)"
					activeColor="rgb(90, 199, 37) " :disabled="isJIEDAI">
				</u-switch>
			</view>
		</view>
		...
		<view class="view-list">
			...
			<view class="kemu"></view>
			<view class="flex flex-ac">
				<view style="padding-right:5rpx">{{ isJIEDAI ? '是' : '否' }}</view>
				<u-switch space="2" v-model="isJIEDAI" size="30" inactiveColor="rgb(245, 108, 108)"
					activeColor="rgb(90, 199, 37) ">
				</u-switch>
			</view>
		</view>

<template>
  <view>
    <u-navbar :is-back="true" :border-bottom="false" back-icon-color="#000" :background="background" title-color="#000" title="利润表" :height="55">
    </u-navbar>
    ...
    <u-tabs-swiper bar-height="4" bar-width="95" ref="tabs" :font-size="32" active-color="#4396F7" :active-item-style="{'color':'#4396F7'}" :current="swiperCurrent" @change="tabsChange" :list="tabList" :is-scroll="false" :bar-style="barStyle">
    </u-tabs-swiper>
      ...
      <view class="popup-main">
        ...
        <view class="popup-box">
          ...
          <view class="popup-bottom">
            <view class="popup-bottom-item" @click="selectDate(index)" :class="{active:num==index+1,disable:monthArr.indexOf(item)<0}" v-for="(item,index) in seasonList" :key="index">
              {{item}}期
            </view>
          </view>
        </view>
      ...
      <view class="popup-main">
        ...
        <view class="popup-box">
          ...
          <view class="popup-bottom justify-around">
            <view class="popup-bottom-item" style="width: 110rpx;height: 110rpx;" @click="selectDate2(index)" :class="{active:num==index+1}" v-for="(item,index) in saisonList" :key="index">
              {{item}}
            </view>
          </view>
        </view>

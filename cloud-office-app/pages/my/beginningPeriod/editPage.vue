<template>
	<view>
		...
		<u-form ref="uForm">
			...
			<u-form-item v-if="currentIndex == 0" :border-bottom="false" label="科目核算明细" label-width="190"
				right-icon="arrow-right" :right-icon-style="{color:'#7d7f97'}">
				<input style="width: 100%;" @click="goDetailPage(formData.id)" type="text" value="" placeholder=""
					disabled />
			</u-form-item>

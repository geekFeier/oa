					...
					<view class="form-item-radio" slot="right">
						<view class="form-item-radio-div" @click="changeCurrent1(1)">
							<image style="width: 40rpx;height: 40rpx;margin-right: 12rpx;"
								:src="currentIndex1==1 ? selecta : select" mode=""></image>
							<text>企业</text>
						</view>
						<view class="form-item-radio-div" @click="changeCurrent1(2)">
							<image style="width: 40rpx;height: 40rpx;margin-right: 12rpx;"
								:src="currentIndex1==2 ? selecta : select" mode=""></image>
							<text>个人</text>
						</view>
					</view>
				</u-form-item>
				...
				<u-form-item label="开票类型" label-width="150">
					<view class="form-item-radio" slot="right">
						<view class="form-item-radio-div" @click="changeCurrent2(1)">
							<image style="width: 40rpx;height: 40rpx;margin-right: 12rpx;"
								:src="currentIndex2==1 ? selecta : select" mode=""></image>
							<text>电子</text>
						</view>
						<view class="form-item-radio-div" @click="changeCurrent2(2)">
							<image style="width: 40rpx;height: 40rpx;margin-right: 12rpx;"
								:src="currentIndex2==2 ? selecta : select" mode=""></image>
							<text>纸质</text>
						</view>
					</view>
				</u-form-item>
	...
	export default {
		...
		methods: {
			submitBtn() {
				...
				if (!/^1(3|4|5|7|8|9|6)\d{9}$/i.test(this.phone)) return uni.showToast({
					title: "请输入正确的手机号码",
					icon: "none"
				})

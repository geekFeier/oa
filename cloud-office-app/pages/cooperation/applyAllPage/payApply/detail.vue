<template>
  <view>
     <u-navbar :is-back="true" title="支付申请" :border-bottom="false" back-icon-color="#000" :background="background" title-color="#000" :height="55">
    </u-navbar>
      ...
      <view class="mainBox">
        ...
        <view class="form-item">
          ...
          <view class="form-item-img-list">
            <image v-for="(item,index) in imgData" :src="item" @click="previewBtn" class="form-item-img-list-i" mode=""></image>
          </view>
        </view>
      </view>
